Public Class generate_eoa_account
    ...
    Public Shared Sub exe(coin_name As String, public_key As String, open As Boolean)
        ...
        Insertcmd = New MySqlCommand("up_insert_account", Connection_mariadb_main)
        Insertcmd.CommandType = CommandType.StoredProcedure

        Insertcmd.Parameters.Add(New MySqlParameter("id", GR.current_id))
        ...
        'BEGIN
        'INSERT INTO bc_manager.security_smart_contracts
        '(
        '`eoa`,
        '`o_balance`,    
        '`o_idate`, 
        ...
        Insertcmd = New MySqlCommand("up_insert_security_smart_contracts", Connection_mariadb_main)
        Insertcmd.CommandType = CommandType.StoredProcedure
