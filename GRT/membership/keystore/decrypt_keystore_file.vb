...
Public Class decrypt_keystore_file
    ...
    Public Shared Function exe(coin_name As String, password As String, public_key As String) As String
        ...
        Try
            ...
            If coin_name = "guarantee" Or coin_name = "ethereum" Then
                file_folder = GRT.GR.account.keyfile_folder
            End If

            Dim directory_info As New DirectoryInfo(file_folder)
            ...
            If found Then
                ...
                Dim hexa_key As String = "0x" & byte_to_hex.exe(key)
