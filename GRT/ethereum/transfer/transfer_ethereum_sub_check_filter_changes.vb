...
Public Class transfer_ethereum_sub_check_filter_changes
        ...
        While True
            ...
            If mode = "initial" Then
                ...
                If rolling_times > GRT.GR.ethereum_transaction_rolling_times Then
                    ...
                    'filterChanges = Await web3.Eth.Filters.GetFilterChangesForBlockOrTransaction.SendRequestAsync(transfer_data.pendingFilter)
