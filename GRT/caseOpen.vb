...
Public Class caseOpen
    ...
    Public Class checkOpen
        ...
        Public Shared Function balance(public_key As String) As Boolean()
            ...
            Dim Connection_mariadb_remote As New MySqlConnection(GR.cString_mariadb_remote_bc_manager)

            Connection_mariadb_remote.Open()
            ...
            Selectcmd = New MySqlCommand("up_select_case_open_balance", Connection_mariadb_remote)
            ...
            Connection_mariadb_remote.Close()
