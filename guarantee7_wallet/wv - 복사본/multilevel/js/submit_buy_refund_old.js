var class_submit_buy_refund = function () {

    var Me; this.initialize = function () { Me = c_submit_buy_refund; }
    ...
    this.exe = function ($button) {
        ...
        let btn_type = $button.prop('id').match(/buy|refund/);

        let in_period = c_check_days_span.exe(btn_type, $tr_parent);
...
}; var c_submit_buy_refund = new class_submit_buy_refund();