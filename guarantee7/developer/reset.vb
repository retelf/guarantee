...
Public Class reset
    ...
    Public Shared Sub exe_data(block_number As Long)
        ...
        For i = 1 To cString.Length - 1
            ...
            reset_query =
                ...
                "USE bc_nft; DELETE FROM account WHERE `block_number` >= " & block_number & " OR `block_number` = 0; " &
                "USE bc_nft; DELETE FROM history WHERE `block_number` >= " & block_number & " OR `block_number` = 0; " &
                "USE bc_nft; DELETE FROM owner_portion WHERE `block_number` >= " & block_number & " OR `block_number` = 0; " &
                "USE bc_nft; DELETE FROM sell_order WHERE `block_number` >= " & block_number & " OR `block_number` = 0; " &
                "USE bc_nft; DELETE FROM sub_account WHERE `block_number` >= " & block_number & " OR `block_number` = 0; " &
                "USE bc_nft; DELETE FROM terms WHERE `block_number` >= " & block_number & " OR `block_number` = 0; "
