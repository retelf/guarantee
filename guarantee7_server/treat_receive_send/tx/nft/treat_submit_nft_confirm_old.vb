...
Public Class treat_submit_nft_confirm_old
                ...
                If JRS_submit_info_verify("success").ToString = "success" Then
                    ...
                    If initial_transfer = "Y" Then
                        ...
                        If currency = "ethereum" Then
                            balance_na_recaller = Await GRT.get_balance.ethereum(na_recaller)
                        Else
                            balance_na_recaller = GRT.get_guarantee_balance_from_local_server.exe(idate_string, na_idate_string_signature, na_recaller)
                        End If

                        If balance_na_recaller >= price_sum + gasPrice * gasLimit / 1000000000 Then
                        ...
                        Else
                            ...
                            JRS = GRT.make_json_string.exe({{"key", command_key, "quot"}, {"success", "fail", "quot"}}, {{"reason", "거래소 " & na_recaller & " 의 잔고가 부족합니다. 현재 잔고는 " & balance_na_recaller & " " & currency & " 입니다.", "quot"}}, False)
                        ...
                        If pieces_seized_for_check >= pieces_to_recall Then
                            ...
                            If verified Then
                                ...
                                If currency = "ethereum" Then
                                    ...
                                    Else ' transfer_not_succeeded_and_no_need_cancel_transfer

                                        pure_query_for_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer = GRT.GQS_nft_recall.exe_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer(
                                                                                                                                                                                                    owner_portion_block_number,
                                                                                                                                                                                                    sell_order_block_number,
                                                                                                                                                                                                    owner_portion_parent_block_number,
                                                                                                                                                                                                    nfa,
                                        ...
                                        verified = GRT.Security.Gverify.verify(pure_query_for_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer, signiture_for_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer, eoa_recaller)

                                        If verified Then

                                            database_name = "bc" : table_name = "account" : query_type = "UPDATE" : contract_type = command_key

                                            JRS = Await self_input_and_relay.exe(command_key, block_number, received_block_hash, previous_hash, eoa_recaller, database_name, table_name, query_type, contract_type, pure_query_for_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer, signiture_for_ethereum_transfer_not_succeeded_and_no_need_cancel_transfer, JSS) ' 부모서버로부터 릴레이 받은 경우임.  
                                ...
                                Else
                                    ...
                                    balance_na_recaller = GRT.get_guarantee_balance_from_local_server.exe(idate_string, json("value")("na_idate_string_signature").ToString, na_recaller)

                                    If balance_na_recaller >= price_sum Then
