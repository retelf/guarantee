...
Public Class treat_multilevel_submit_buy_ethereum_transfer

    Public Shared Async Function exe(json As Newtonsoft.Json.Linq.JObject) As Task(Of String)

        Dim JRS As String
        Dim howto As String
        Dim case_retored_eoa_from, signiture_data_for_ethereum_transfer(1) As String
            ...
            Else ' tx_pending_so_long
                ...
                If transfer_data.tem_transaction_success_cancel Then
                    ...
                    If transfer_data.cancel_success Then
                        ...
                        howto = get_howto.multilevel_buy_transfer_fail_clear(amount, gasPrice, gasLimit)
                    ...
                    Else ' tx_pending_so_long_in_cancel
                        ...
                        howto = get_howto.multilevel_buy_transfer_success_unclear(
                                exchange_rate,
                                buyer_na,
                                exchange_name,
