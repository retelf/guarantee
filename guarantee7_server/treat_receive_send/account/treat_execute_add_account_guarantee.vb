Public Class treat_execute_add_account_guarantee
    ...
    Public Shared Async Function exe(json As Newtonsoft.Json.Linq.JObject, JSS As String) As Task(Of String)
        ...
        'query_signiture_representative = json("value")("signiture_representative").ToString

        '' 먼저 검증

        'pure_query = GRT.GQS_insert_account_pure_query.exe(eoa_new, eoa_representative, balance, node, idate_string)
