...
Public Class guarantee_server_async_thread_ethereum
    ...
    Public Shared Async Sub exe()
        ...
        Dim localEndPoint As IPEndPoint = New IPEndPoint(ipAddress, GRT.GR.port_number_server_local_ethereum)
        ...
        Try
            ...
            While True
                ...
                Callback_server.SetControl("txt_monitor", "write", vbCrLf & "Waiting for a ethereum transfer connection...", "")
