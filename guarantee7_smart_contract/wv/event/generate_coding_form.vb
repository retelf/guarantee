...
Public Class generate_coding_form

    Shared html_directory As String = Regex.Replace(Directory.GetCurrentDirectory, "guarantee7\\guarantee7.+", "guarantee7\guarantee7_smart_contract\wv\html")

    Public Shared Sub exe()

        If Not GRT.GR.account.login_state = "no_login" Then

            GR.control.wv_working.CoreWebView2.Navigate(html_directory & "\coding.html")
    ...
    Shared Async Sub UpdateContent(ByVal sender As Object, ByVal args As CoreWebView2WebMessageReceivedEventArgs)
        ...
        Select Case json_webview("key").ToString
            ...
            Case "initialize_textarea_code_general"

                Dim file_info As New FileInfo(html_directory & "\wallet_source.html")
                ...
                Dim result = GR.control.wv_working.CoreWebView2.ExecuteScriptAsync(
